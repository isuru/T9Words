class T9Words
  def self.search(phone_number)
    ...
    if File.exists?(dictionary_file)
      ...
      names = all_names.each(&:strip!).select{ |name| name if (name.size >= 3 && name.size <= 10) } # Limitting to 3..10 character words
      ...
      names_6R = names.select{|name|
        ...
        name[5] && name[4].match(t9_map[phone[8]]) &&
      ...
      #   name[0].match(t9_map[phone[0]]) &&
      #   name[1].match(t9_map[phone[1]]) &&
      #   name[2].match(t9_map[phone[2]]) &&
      #   name[3].match(t9_map[phone[3]]) &&
      #   name[4].match(t9_map[phone[4]]) &&
      #   name.strip.size == 5
      # }
      # names_5R = names.select{|name|
      #   name[0].match(t9_map[phone[5]]) &&
      #   name[1].match(t9_map[phone[6]]) &&
      #   name[2].match(t9_map[phone[7]]) &&
      #   name[3].match(t9_map[phone[8]]) &&
      #   name[4].match(t9_map[phone[9]]) &&
      #   name.strip.size == 5
      # }
      ...
      #   name[3].match(t9_map[phone[3]]) &&
      #   name[4].match(t9_map[phone[4]]) &&
      #   name[5].match(t9_map[phone[5]]) &&
      #   name.strip.size == 6
      # }
      # names_4R = names.select{|name|
      #   name[0].match(t9_map[phone[6]]) &&
      #   name[1].match(t9_map[phone[7]]) &&
      #   name[2].match(t9_map[phone[8]]) &&
      #   name[3].match(t9_map[phone[9]]) &&
      #   name.strip.size == 4
      # }
      ...
      #   name[4].match(t9_map[phone[4]]) &&
      #   name[5].match(t9_map[phone[5]]) &&
      #   name[6].match(t9_map[phone[6]]) &&
      #   name.strip.size == 7
      # }
      # names_3R = names.select{|name|
      #   name[0].match(t9_map[phone[7]]) &&
      #   name[1].match(t9_map[phone[8]]) &&
      #   name[2].match(t9_map[phone[9]]) &&
      #   name.strip.size == 3
      # }
      ...
      #   name[5].match(t9_map[phone[5]]) &&
      #   name[6].match(t9_map[phone[6]]) &&
      #   name[7].match(t9_map[phone[7]]) &&
      #   name[8].match(t9_map[phone[8]]) &&
      #   name[9].match(t9_map[phone[9]]) &&
      #   name.strip.size == 10
      # }
